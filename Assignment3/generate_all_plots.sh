...
python3 generate_plots.py --timesteps 50000 --algorithms "SARSA" --title "8 moves with stochasticity" --colors g --outfile sarsa_8_stoch.png --min_policy --heatmap --eight_moves --stochastic
